...
export function Dashboard() {
  return (
    <Shell active="dashboard" title="" hideSidebarRobot minH="76.5vh">
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '3fr 2fr' }, gap: 2, alignItems: 'stretch', position: 'relative', zIndex: 1 }}>
        ...
        <Card variant="outlined" sx={{ borderColor: 'divider', borderRadius: 2, boxShadow: (t) => t.shadows[3], height: '100%' }}>
