...
import { TrafficPill, GradePill } from './Practice';
    ...
    <Stack spacing={0.25}>
      {lines.map((line, i) => (
        <Stack key={i} direction="row" spacing={1.25} alignItems="baseline">
          ...
          <Typography component="span" variant="caption" sx={{ minWidth: 16, textAlign: 'center', flexShrink: 0, color: (t) => alpha(t.palette.common.white, 0.7), fontWeight: 700, fontFeatureSettings: '"tnum","lnum"' }}>
            {i + 1}
          </Typography>
